...
فایل‌های دانلود شده در پوشه های `videos/` و 'downloads/' قرار می‌گیرند. برای فایل‌های بزرگ، چند تکه زیپ شده ایجاد می‌شود که باید همگی را دانلود و سپس فایل zip اکسترکت کنید، این فایل بطور خودکار فایل های z1, z2 و... را پیدا میکند.
...
- ✅ فشرده‌سازی خودکار و تحویل به صورت زیپ شده و پارت‌بندی شده (هر پارت ۴۵ مگابایت)
...
2. گزینه **پاکسازی پوشه‌های دانلود و ویدیوها** را انتخاب کنید
3. روی **Run workflow** بزنید
